...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1>Gestion des utilisateurs non vérifiés par courrier électronique</h1>
        </div>
     </div>
     <div class="row">
        <div class="col-md-12">
          @if (count($emailUnverifiedUsers) == 0)
            <div class="tile">
              <h3 class="tile-title float-left">Email Liste des utilisateurs non vérifiés</h3>
              ...
              <h2 class="text-center">AUCUN EMAIL UTILISATEUR NON VERIFIE TROUVE</h2>
            </div>
          @else
            <div class="tile">
               <h3 class="tile-title float-left">Email Liste des utilisateurs non vérifiés</h3>
