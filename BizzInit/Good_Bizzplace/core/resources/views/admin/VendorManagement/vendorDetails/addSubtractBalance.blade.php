...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-money"></i>AJOUTER / SOUSTRACTER LA BALANCE</h1>
        </div>
              ...
              <div class="col-md-9">
                <div class="card">
                  <div class="card-header bg-primary">
                    <h3 style="color:white;"><i class="fa fa-money"></i> AJOUTER / SOUSTRACTER LA BALANCE</h3>
                  </div>
                  <div class="card-body">
                    <form class="" action="{{route('admin.updateVendorBalance')}}" method="post">
                      {{csrf_field()}}
              ...
              <div class="col-md-3">
                <div class="card border-primary">
                  <div class="card-header border-primary bg-primary">
                    <h5 style="color:white;"><i class="fa fa-money"></i> SOLDE ACTUEL</h5>
                  </div>
                  <div class="card-body text-center">
                    <h2>BILAN ACTUEL DE</h2>
                    <h2><strong>{{$vendor->shop_name}}</strong></h2>
                    <br>
                    <h2><strong>{{$vendor->balance}} {{$gs->base_curr_text}}</strong></h2>
                  </div>
                </div>
              </div>
            </div>
