...
<div class="modal fade" id="editModal{{$packgifts->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form class="" action="{{route('admin.packgift.update')}}" method="post">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                     ...
                     <textarea class="form-control" name="s_desc" rows="3" cols="80" placeholder="Enter short description">{{$packgifts->description}}</textarea>
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                     <strong>Prix</strong>
                     <input type="text" value="{{$packgifts->price}}" class="form-control" id="name" name="price" placeholder="Entrer prix" >
                  </div>
                </div>
              </div>
              <div class="form-group">
