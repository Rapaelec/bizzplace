...
@section('content')
  <main class="app-content">
     ...
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              <h3 class="tile-title float-left">Liste carte Cadeau</h3>
                  ...
                  <table class="table">
                     <thead>
                        <tr>
                           ...
                           <th scope="col">Durée de validité (En jours)</th> 
...
@push('scripts')
  <script>
    ...
    function DeleteCartgifts(e, pid) {
      e.preventDefault();
      swal({
        title: "Êtes vous sûre cette carte ?",
        text: "La suppression de cette carte entrainera la perte de donnée de cette .",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
