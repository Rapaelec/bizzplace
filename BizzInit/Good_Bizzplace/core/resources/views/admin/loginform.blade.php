    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form method="post" class="login-form" action="{{route('admin.login')}}">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>CONNEXION ADMIN</h3>
          {{csrf_field()}}
          <div class="form-group">
            <label class="control-label">LOGIN</label>
            <input name="username" class="form-control" type="text" placeholder="Nom utilisateur" autofocus>
