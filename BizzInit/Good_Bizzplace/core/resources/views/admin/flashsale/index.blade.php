     ...
     <div class="row">
        <div class="col-md-12">
            <div class="tile">
              ...
              @if (count($products) == 0)
                <h1 class="text-center"> Aucun produit trouvé !</h1>
              @else
                      ...
                      <tr>
                          ...
                          <td class="padding-top-40">
                            @if ($product->flash_status == 0)
                              <strong class="badge badge-warning">En attente</strong>
                            @elseif ($product->flash_status == 1)
                              <strong class="badge badge-success">Accepté</strong>
                            @else
                              <strong class="badge badge-danger">Rejeté</strong>
                            @endif
                          </td>
                          <td class="padding-top-40">
                            @if ($product->flash_status == 0)
