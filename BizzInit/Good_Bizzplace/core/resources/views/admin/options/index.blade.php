...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1>Gestion Option </h1>
        </div>
     </div>
     <div class="row">
        <div class="col-md-12">
           <div class="tile">
              <h3 class="tile-title pull-left">Tous les options de <strong>{{$pa->name}}</strong></h3>
              <div class="pull-right icon-btn">
                <a class="btn btn-warning" href="{{route('admin.productattr.index')}}">
                  <i class="fa fa-list"></i>Tous les attributs de produits
                </a>
                <a class="btn btn-info" data-toggle="modal" data-target="#addSub{{$pa->id}}">
                  <i class="fa fa-plus"></i> Ajout option
                </a>
              </div>
              ...
              <div class="table-responsive">
                @if (count($options) == 0)
                  <h2 class="text-center"> Aucune données trouvées</h2>
                @else
                  <table class="table">
                     <thead>
                        <tr>
