...
Hello Administrateur,<br>
vous avez reçu nouveau message de <br>
<ul>
 <li>M/Mme/Mlle: {{ $nom_client }}</li>
 <li>Contact téléphonique : {{ $phone_client }}</li>
 <li>Adresse email:  {{ $adress_email }}</li>
</ul>
 <br>
