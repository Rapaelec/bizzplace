            ...
            <div class="container nav-container">
                ...
                <div class="collapse navbar-collapse" id="mirex">
                    ...
                    <ul class="navbar-nav">
                        ...
                        @if (!Auth::guard('vendor')->check())
                          <li class="nav-item">
                              <a class="nav-link" href="{{route('user.home')}}">Acceuil</a>
                          </li>
                          <li class="nav-item">
                        ...
                        @auth ('vendor')
                         ...
                         <!--  <li class="nav-item">
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu">
                                  <a href="{{route('vendor.product.manage')}}" class="dropdown-item">Gestion Produit</a>
                                  <a href="{{route('vendor.product.create')}}" class="dropdown-item">Charger le produit</a>
                              </div>
                          </li>
                          <li class="nav-item dropdown">
                          ...
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a href="{{route('vendor.logout', 1)}}" class="dropdown-item">Se déconnecter</a>
                              </div>
                          </li>
                        @endauth
                        @if (!Auth::guard('vendor')->check())
                        <li class="nav-item dropdown mega-menu"><!-- mega menu start -->
                            <a class="nav-link dropdown-toggle" href="{{route('user.search')}}" data-toggle="dropdown">Nos produits</a>
                        ...
                        <!-- mega menu end -->
                      {{--   <li class="nav-item">
                            <a class="nav-link" href="{{route('user.bestsellers')}}">Ventes</a>
                      </li> --}}

                        <li class="nav-item">
                            <a class="nav-link" href="{{-- {{route('user.contact')}} --}}">Annuaire</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{-- {{route('user.Good_deals_Partners')}} --}}">Bons plans Partenaires</a>
                        </li>
                        {{-- <li class="nav-item">
                        ...
                        @if (!Auth::check() && !Auth::guard('vendor')->check())
                          ...
                          <li class="nav-item">
                              <a class="nav-link" href="{{ route('page_inscription')}}">Inscription Vendeur</a>
                          </li>
                        @elseif (Auth::check())  
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{route('user.orders')}}">Commande</a>
