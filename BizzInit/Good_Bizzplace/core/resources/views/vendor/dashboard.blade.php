...
@section('title', 'Vendeur dashboard')

@section('headertxt', 'Vendeur dashboard')
                          ...
                          <div class="row">
                              <div class="col-lg-4 col-md-6">
                                  <div class="single-mini-card-item bg-light-blue">
                                      ...
                                      <div class="counterup">$<span class="count">{{\App\Vendor::find(1)->balance}}</span></div>
                                  </div>
                              </div>
                              <div class="col-lg-4 col-md-6">
                                  <a href="{{route('vendor.orders')}}" class="single-mini-card-item bg-light-orange">
                                      ...
                                      <div class="counterup"><span class="count">{{count(\App\Orderedproduct::join('orders', 'orders.id', '=', 'orderedproducts.order_id')->select('order_id', DB::raw('count(order_id) as total'))->where('vendor_id', 1)->whereIn('orders.approve', [0, 1])->groupBy('order_id')->get())}}</span></div>
                                  </a>
                              </div>
                              <div class="col-lg-4 col-md-6">
                                  <a href="{{route('vendor.product.manage')}}" class="single-mini-card-item bg-light-gray">
                                      ...
                                      <div class="counterup"><span class="count">{{\App\Product::where('vendor_id', 1)->count()}}</span></div>
                                  </a>
                              </div>
                          </div>
                          <br>
