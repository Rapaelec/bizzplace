          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <div id="successAlert" class="alert alert-success alert-dismissible fade show d-none">
                    <p><strong class="text-success">Votre package est valable jusqu'au {{date('jS M, Y', strtotime($vendor->expired_date))}} et peut télécharger {{$vendor->products}} produits.</strong></p>
