...
class SliderController extends Controller
{
    ...
    public function store(Request $request) {
      $messages = [
        'btxt.required' => 'les champs en gras sont obligatoires',
        'stxt.required' => 'un petit champ de texte est requis',
      ];
      ...
      $slider->save();
      Session::flash('success', 'Image du slider ajoutée avec succès!');
    ...
    public function delete(Request $request) {
      ...
      Session::flash('success', 'Image du slider supprimé avec succès!');
      return redirect()->back();
    }
}
