...
@section('content')
            ...
            <div class="tile">
              <div class="row mb-4">
                ...
                <div class="col-md-3 offset-md-6">
                  ...
                  "
                  >
                    <input class="form-control" type="text" name="term" value="{{$term}}" placeholder="Rechercher par nom de magasin">
                  </form>
                </div>
              </div>
              @if (count($vendors) == 0)
                  ...
                  <tbody>
                    @foreach ($vendors as $key => $vendor)
                      <tr>
                          ...
                          <td>{{$vendor->email}}</td>
                          <td>{{$vendor->phone}}</td>
                          <td class="padding-top-40">{{date('j F, o', strtotime($vendor->created_at))}}</td>
                          <td>
  ...
  @includeif('admin.vendors.partials.create')
@endsection
