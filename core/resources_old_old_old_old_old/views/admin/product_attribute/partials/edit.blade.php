    ...
    <div class="modal-content">
      <form class="" action="{{route('admin.productattr.update')}}" method="post">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Modifier l'attribut du produit</h5>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-10">
                    ...
                    <select class="form-control" name="status">
                      <option value="1" {{($pa->status==1) ? 'selected' : ''}}>Activer</option>
                      <option value="0" {{($pa->status==0) ? 'selected' : ''}}>Desactiver</option>
                    </select>
                  </div>
                </div>
              </div>
