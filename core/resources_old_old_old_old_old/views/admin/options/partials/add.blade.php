    ...
    <div class="modal-content">
      <form class="" action="{{route('admin.options.store')}}" method="post">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ajouter des options sous <strong>{{$pa->name}}</strong></h5>
              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-12 mb-10">
                     <strong>Nom Option</strong>
                     <input type="text" value="" class="form-control" id="name" name="name" placeholder="Entre le nom d'une option" >
                  </div>
                  <div class="col-md-12 mb-10">
