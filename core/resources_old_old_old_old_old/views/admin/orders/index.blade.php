                  ...
                  <tbody>
                    @foreach ($orders as $key => $order)
                      <tr>
                          ...
                          <td class="padding-top-40">
                              <a href="{{route('admin.orderdetails', $order->id)}}" target="_blank" title="Voir commande"><i class="text-primary fa fa-eye"></i></a>
                              @if ($order->approve == 0)
                                <span>
                                  <a href="#" onclick="cancelOrder(event, {{$order->id}})" title="Commande Rejétée">
                                    <i class="fa fa-times text-danger"></i>
                                  </a>
                                  <a href="#" onclick="acceptOrder(event, {{$order->id}})" title="Commande acceptée">
