...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h3 class="page-title uppercase bold"> <i class="fa fa-desktop"></i> Retirer le journal</h3>
        </div>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-info" href="{{route('withdrawLog.show', $withdraw->id)}}" target="_blank">Details</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
