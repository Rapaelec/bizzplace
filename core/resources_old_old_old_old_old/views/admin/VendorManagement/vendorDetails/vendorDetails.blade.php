...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-dashboard"></i> Détails du prestataire</h1>
        </div>
              ...
              <div class="col-md-9">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        <a href="{{route('admin.vendor.addSubtractBalance', $vendor->id)}}" style="color:white;" class="btn btn-info btn-block"><i class="fa fa-money"></i> AJOUTER / SOUSTRACTER LA BALANCE</a>
                      </div>
                      <div class="col-md-6">
                        <a href="{{route('admin.emailToVendor', $vendor->id)}}" style="color:white;" class="btn btn-danger btn-block"><i class="fa fa-envelope"></i> ENVOYER MAIL</a>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-header bg-primary">
                    <h3 style="color:white;"><i class="fa fa-cog"></i> METTRE À JOUR LE PROFIL</h3>
                  </div>
                  <div class="card-body">
                    <form class="" action="{{route('admin.updateVendorDetails')}}" method="post">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label for=""><strong>Boutique</strong></label>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <button type="submit" class="btn btn-info btn-block" name="button">Mettre à jour</button>
                        </div>
                      </div>
                    </form>
                  </div>
