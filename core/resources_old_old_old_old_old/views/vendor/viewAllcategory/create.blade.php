            ...
            <div class="tile">
              <div class="tile-body">
                  <h3></h3>
                    <form action="{{route('vendor.categoryAllstore')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-4">
                            ...
                            <select name="categorie" id="categorie" class="form-control">
                                <option value="{{ App\Category::where('slug',$categoris)->first()->id }}">{{ $categoris }}</option>
                            </select>
                      </div>
                      <div class="col-md-4">
                    ...
                    <div class="row mt-5">
                         <div class="col-md-12">
                             <button type="submit" class="btn btn-block btn-primary">{{ $category->validation==0 ? 'PUBLIER' : 'ENREGISTRER' }}</button>
                         </div>
                     </div>
                    </div>
                    </form>
