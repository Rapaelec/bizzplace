                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-element margin-bottom-20">
                                    ...
                                    <input name="old_password" type="password" class="input-field" placeholder="{{ __('Ancien mot de passe') }}...">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-element margin-bottom-20">
                                    ...
                                    <input name="password" type="password" class="input-field" placeholder="{{ __('Nouveau mot de passe') }}">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-element margin-bottom-20">
                                    ...
                                    <input name="password_confirmation" type="password" class="input-field" placeholder="{{ __('Confirmer votre mot de passe') }}">
                                </div>
                              </div>
                            </div>
