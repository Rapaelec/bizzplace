                                ...
                                <div class="col-lg-4 col-md-6">
                                  <div class="single-new-collection-item "><!-- single new collections -->
                                      ...
                                      <div class="content">
                                          ...
                                          <a class="btn btn-outline-primary" href="{{route('user.product.details', [Illuminate\Support\Str::slug($product->unique('vendor_id')[0]->category->true_name),$product->unique('vendor_id')[0]->vendor->id])}}">Plus d'information</a>
                               ...
                               <div class="single-new-collection-item "><!-- single new collections -->
                                <div class="thumb">
                                  @if(!empty($allcategorie[0]->vendor->logo))
                                    <img src="{{ asset('assets/user/img/shop-logo/'.$allcategorie[0]->vendor->logo) }}" alt="nouvelle collection image" class="border">
                                  @else
