                  ...
                  <div class="right-content-area"><!-- right content area -->
                      ...
                      <div class="bottom-content"><!-- top content -->
                          <div class="row">
                            ...
                            @else
                              @foreach ($allcategories as $key => $product)
                              @if($product->category->product_validate==1)
                                  ...
                                  <div class="single-new-collection-item "><!-- single new collections -->
                                      <div class="thumb">
                                        {{-- {{ dd($product) }} --}}
                                          ...
                                          <div class="hover">
                                              <a href="{{route('user.OtherproductDetail.show', [$product->slug, $product->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                                          </div>
                                      </div>
                                      <div class="content">
                                          <span class="category">{{\App\Category::find($product->category_id)->name}}</span>
                                          <a href="{{route('user.OtherproductDetail.show', [$product->slug,$product->id])}}"><h4 class="title">{{strlen($product->title) > 25 ? substr($product->title, 0, 25) . '...' : $product->title}}</h4></a>
                              ...
                              <div class="col-md-12">
                                <div class="text-center">
                                    {{$allcategories->appends($parameters)->links()}}
                                </div>
                              </div>
                            @endif
                          </div>
