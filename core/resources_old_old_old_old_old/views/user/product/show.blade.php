          ...
          <div class="row">
              <div class="col-lg-3">
                  ...
                  <div class="category-compare margin-bottom-30">
                     ...
                     <div class="">
                     {{-- {{ dd( URL::current().'/shop'.'/'.Request::route('category').'/'.Request::route('subcategory')) }} --}}
                                  ...
                                  <div class="single-new-collection-item "><!-- single new collections -->
                                      <div class="thumb">
                                        {{-- {{ dd($product->ima }} --}}
                                          ...
                                          <div class="hover">
                                              <a href="{{route('user.product.show', [$product->slug, $product->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                                          </div>
                                      </div>
                                      <div class="content">
                                          <span class="category">{{\App\Category::find($product->category_id)->name}}</span>
                                          <a href="{{route('user.product.show', [$product->slug,$product->id])}}"><h4 class="title">{{strlen($product->title) > 25 ? substr($product->title, 0, 25) . '...' : $product->title}}</h4></a>
