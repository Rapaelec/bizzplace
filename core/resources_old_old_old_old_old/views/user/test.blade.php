...
<meta name="csrf-token" content="CVrvhPSFfMRuk3HsWsiJlrJiK187oS979cOQsP2D">
<title> Bigenja | Stripe </title>
<!-- favicon -->
                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="right-content-area"><!-- right content area -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="http://localhost/ecommerce/wishlist">Wishlist</a>
                                    </li>
                                    <li>
                                        <a href="http://localhost/ecommerce/orders">Orders</a>
                                    </li>
                                    <li>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="http://localhost/ecommerce/login" class="dropdown-item">User</a>
                            </div>
                        </li>
                                            </ul>
                    <!-- /.navbar-nav -->
          ...
          <div class="bottom-content"><!-- bottom content -->
              <div class="cart-products"><!-- cart product -->
                  ...
                  <div class="">
                                          ...
                                          <div class="single-product-item" id="singleitem24"><!-- single product item -->
                          <div class="thumb">
                          ...
                          <div class="content">
                              ...
                              <div class="price"><span class="pprice">৳ 1500.00</span> <del class="dprice">$500.00</del> <span class="sidequantity" id="quantity24">(3)</span></div>
                              <a href="#" class="remove-cart" @click="precartlen--;removeproduct(24)">Remove</a>
                          </div>
                    ...
                    <div class="single-product-item" v-for="(product, index) in products"><!-- single product item -->
                        ...
                        <div class="content">
                            ...
                            <a href="#" class="remove-cart" @click="products.splice(index, 1);removeproduct(product.cart_id)">Remove</a>
                        </div>
                    </div><!-- //. single product item -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner"><!-- breadcrumb inner -->
                    <div class="left-content-area"><!-- left content area -->
                        <h1 class="title">Stripe Payment</h1>
                    </div><!-- //. left content area -->
	...
	<div class="row">
		<div class="col-md-8 offset-md-2">
				<div class="well" style="margin:50px 0px;">
					...
					<form role="form" id="payment-form" method="POST" action="http://localhost/ecommerce/ipnstripe/payment" >
						<input type="hidden" name="_token" value="CVrvhPSFfMRuk3HsWsiJlrJiK187oS979cOQsP2D">
						<input type="hidden" value="aRd9NmIKdGKf1G9D" name="track">
						<div class="row">
							<div class="col-md-6">
...
<script src="http://localhost/ecommerce/assets/user/js/sweetalert.min.js"></script>
...
<script type="text/javascript" src="http://localhost/ecommerce/assets/stripe/payvalid.js"></script>
<script type="text/javascript" src="http://localhost/ecommerce/assets/stripe/paymin.js"></script>
<script type="text/javascript" src="https://js.stripe.com/v2/"></script>
<script type="text/javascript" src="http://localhost/ecommerce/assets/stripe/payform.js"></script>
...
var example1 = new Vue({
  ...
  methods: {
    addtocart(productid, quantity) {
      ...
      $.ajax({
        url: 'http://localhost/ecommerce/cart/getproductdetails',
        type: 'POST',
        data: fd,
        contentType: false,
        processData: false,
    ...
    showsubcats: function() {
      ...
      $.get(
        'http://localhost/ecommerce/vendor/product/getsubcategories',
        {
          catid: this.catid
        },
        function(data) {
    ...
    showattrs: function() {
      ...
      $.get(
        'http://localhost/ecommerce/vendor/product/getattributes',
        {
