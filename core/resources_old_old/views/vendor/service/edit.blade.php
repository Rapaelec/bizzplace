         ...
         <div class="row">
           <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                  <h3></h3>
                    <form action="{{route('vendor.service.update',$services->id)}}" method="post" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="col-md-4">
                       ...
                       <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="nom" id="nom" value="{{ $services->nom }}">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="ville" id="ville" value="{{ $services->ville }}">
                        </div>
                        </div> <!--row-->
                        <div class="row mt-2">
                        <div class="col-md-4">
                         <label for="departement" class="col-form-label">Departement<span class="text-danger"> **</span></label>
                         <input type="text" class="form-control" name="departement" id="departement" value="{{ $services->departement }}"> 
                        </div>
                        <div class="col-md-4">
                            <label for="rue" class="col-form-label">Nom de la rue<span class="text-danger"> **</span></label>
                            <input type="text" name="rue" id="rue" class="form-control" value="{{ $services->rue }}">
                        </div>
                        <div class="col-md-4">
                            <label for="cod_postal" class="col-form-label">Code postal<span class="text-danger"> **</span></label>
                            <input type="text" name="cod_postal" id="cod_postal" class="form-control" value="{{ $services->cod_postal }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                          <label for="site_prest" class="col-form-label">Site du prestataire<span class="text-danger"> **</span></label>
                          <input type="text" name="site_prest" id="site_prest" class="form-control" value="{{ $services->site_prest }}" placeholder="http://www.bizzplace.fr">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                          <label for="site_prest_racv" class="col-form-label">Site RACV du prestataire<span class="text-danger"> **</span></label>
                          <input type="text" name="site_prest_racv" id="site_prest_racv" value="{{ $services->site_prest_racv }}" class="form-control" placeholder="http://www.bizzplace.racv.fr">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                          <label for="keywords" class="col-form-label">Mot clé<span class="text-danger"> (Optionnel)</span></label>
                          <input type="text" name="keywords" id="keywords" class="form-control" value="{{ $services->keywords }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                         <label for="description" class="col-form-label">Description<span class="text-danger"> **</span></label>
                         <textarea class="form-control  nicEdit-main" name="description" id="description" rows="8px"> {{ $services->description }} </textarea>
                        </div>
                    </div>
                    <div class="row mt-5">
                         <div class="col-md-12">
