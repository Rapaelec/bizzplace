         ...
         <div class="row">
           <div class="col-md-12">
            <div class="tile">
              <div class="tile-body">
                  <h3></h3>
                    <form action="{{route('vendor.immobilier.store')}}" method="post" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="piece" id="piece" class="form-control">
                        </div>
                        <div class="col-md-4">
                     ...
                     <div class="row mt-2">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="chambre" id="chambre">
                        </div>
                        <div class="col-md-4">
                            <label for="terrain" class="col-form-label">Superficie terrain (en m<sup>2</sup>)<span class="text-danger"> **</span></label>
                            <input type="text" class="form-control" name="terrain" id="terrain">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                         ...
                         <input type="text" class="form-control" name="autre_info" id="autre_info" placeholder="piscine,jardin,jacouzzi..."> 
                        </div>
                        <div class="col-md-4">
                         <label for="salle_de_bain" class="col-form-label">Nombre de salle de bain<span class="text-danger"> **</span></label>
                         <input type="text" class="form-control" name="salle_de_bain" id="salle_de_bain"> 
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
