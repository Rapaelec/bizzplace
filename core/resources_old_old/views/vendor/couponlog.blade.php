...
@section('title', 'Historique Coupon')

@section('headertxt', 'Historique Coupon')
                  ...
                  <div class="seller-product-wrapper">
                      <div class="seller-panel">
                          <div class="card-header">
                                  <div class="row">
                                    <div class="col-md-4">
                                      <h3 class="text-white mb-0">Historique Coupon</h3>
                                    </div>
                                    <div class="col-md-8">
                                      <div class="row">
                                        <div class="col-md-12">
                                          <form method="get" action="{{url()->current()}}">
                                            <div class="row">
                                              <div class="col-md-3">
                                                <input class="form-control" type="text" name="order_id" value="{{request()->input('order_id')}}" placeholder="Commande ID">
                                              </div>
                                              <div class="col-md-3">
                                                <input class="form-control" id="from_date" type="text" name="from_date" value="{{request()->input('from_date')}}" placeholder="De" autocomplete="off">
                                              </div>
                                              <div class="col-md-3">
                                                <input class="form-control" id="to_date" type="text" name="to_date" value="{{request()->input('to_date')}}" placeholder="A" autocomplete="off">
                                              </div>
                                              <div class="col-md-3">
                                                <input class="btn btn-dark btn-block" type="submit" name="" value="Soumettre">
                                              </div>
                                            </div>
                                          </form>
                                        </div>
                                      ...
                                      <tbody>
                                        @foreach ($logs as $log)
                                          <tr>
                                            ...
                                            <td class="padding-top-40">{{date('j M Y', strtotime($log->created_at))}}</td>
