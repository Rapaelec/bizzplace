                ...
                <form class="form-horizontal" action="{{route('admin.contact.update')}}" method="post" role="form">
                   ...
                   <div class="form-body">
                     <div class="form-group">
                        <label class="col-md-12 "><strong style="text-transform: uppercase;">Téléphone</strong></label>
                        <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <label class="col-md-12 "><strong style="text-transform: uppercase;">Adresse</strong></label>
                        <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <label class="col-md-12 "><strong style="text-transform: uppercase;">Temps de travail</strong></label>
                        <div class="col-md-12">
                      ...
                      <div class="form-group">
                         <div class="col-md-12">
                            <button type="submit" class="btn btn-info btn-block btn-lg">METTRE A JOUR</button>
                         </div>
                      </div>
                   </div>
                </form>
