                  ...
                  {{csrf_field()}}
                   <div class="form-body">
                     <div class="form-group">
                        <label class="col-sm-12 control-label"><strong>Image bannière</strong></label>
                        <div class="col-sm-12"><input type="file" name="slider"></div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-12 control-label"><strong>Titre</strong></label>
                        <div class="col-sm-12"><input type="text" name="title" class="form-control input-lg"></div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-12 control-label"><strong>Texte en gras</strong></label>
                        <div class="col-sm-12"><input type="text" name="btxt" class="form-control input-lg"></div>
                     </div>
                     <div class="form-group">
                        <label class="col-sm-12 control-label"><strong>Petit texte</strong></label>
