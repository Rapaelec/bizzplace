...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-envelope"></i>ENVOYER UN E-MAIL À L'UTILISATEUR</h1>
        </div>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header bg-primary">
                    <h4 style="color:white;"><i class="fa fa-envelope"></i> ENVOYER UN COURRIEL À {{$vendor->username}}</h4>
                  </div>
                  <div class="card-body">
