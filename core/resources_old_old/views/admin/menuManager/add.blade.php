  ...
  <main class="app-content">
     <div class="app-title">
        <div class="row" style="width:100%;">
          <div class="col-md-6">
            <h1 class="d-inline-block">Gestion du menu</h1>
          </div>
          <div class="col-md-6 text-right">
            <a href="{{route('admin.menuManager.index')}}" class="float-right btn btn-primary">Listes Menu </a>
          </div>
        </div>
     </div>
     <div class="row">
                   ...
                   <div class="form-body">
                     <div class="col-md-12">
                      ...
                      <div class="row">
                         <div class="col-md-12">
                           <div class="col-md-12">
                             <button type="submit" class="btn btn-info btn-block btn-lg">AJOUTER MENU</button>
                           </div>
                         </div>
                      </div>
                   </div>
