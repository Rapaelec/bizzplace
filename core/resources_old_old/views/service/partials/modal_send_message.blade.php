<!-- Modal send mail -->
<div class="modal fade" id="sendMessageAnnonceur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
          ...
          <div class="modal-body">
              {{csrf_field()}}
            <input type="hidden" name="email_vendor" class="email_vendor" value="{{ $services->vendor->email}}">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                     ...
                     <input type="text" class="form-control" id="subject" name="subject" placeholder="Sujet email">
                    </div>
                </div>
              </div>
              <div class="form-group">
