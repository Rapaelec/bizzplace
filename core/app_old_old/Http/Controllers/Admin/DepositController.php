...
class DepositController extends Controller
{
    ...
    public function accept(Request $request) {
      ...
      $tr->save();
       ...
       send_email($vendor->email,$vendor->shop_name,$vendor->phone, $vendor->email, "Deposit request accepted", $message);
    ...
    public function rejectReq(Request $request) {
      ...
      send_email($vendor->email,$vendor->shop_name,$vendor->phone , $vendor->email, "Demande de dépôt rejetée", $message);
