...
class PagesController extends Controller
{
    public function home() {
      ...
      $topSoldPros = Product::with('previewimages')->where('deleted', 0)->orderBy('sales', 'DESC')->limit(6)->get();
      $data['topSoldPros'] = $topSoldPros;

      // fetch top rated products
      $topRatedPros = Product::with('previewimages')->where('deleted', 0)->orderBy('avg_rating', 'DESC')->limit(6)->get();
      $data['topRatedPros'] = $topRatedPros;


      // fetch special products
      $data['specialPros'] = Product::with('previewimages')->whereNotNull('current_price')->where('deleted', 0)->orderBy('id', 'DESC')->limit(8)->get();

      // fetch recent products
      $data['latestPros'] = Product::with('previewimages')->where('deleted', 0)->orderBy('id', 'ASC')->get();
