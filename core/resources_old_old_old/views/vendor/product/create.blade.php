                  ...
                  <div class="product-upload-inner"><!-- product upload inner -->
                      <form id="uploadForm" class="product-upload-form" onsubmit="upload(event)" enctype="multipart/form-data">
                          ...
                          <div class="form-group margin-bottom-20">
                            <label for="" class="sec-txt">Aperçu des images<span style="color:red">**</span></label>
                            <div class="">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group margin-bottom-20">
                                      <label>Stock (quantité) <span style="color:red">**</span></label>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group margin-bottom-20">
                                      <label>Prix ({{$gs->base_curr_text}})<span style="color:red">**</span></label>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-group margin-bottom-20">
                                  <label>Sous catégories <span style="color:red">**</span></label>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group margin-bottom-20">
                                    <label>Mot clé<span class="text-danger">(Optionel)</span></label>
                                    <input name="price_min" type="text" class="form-control prix_qtite_min" placeholder="Entrer un mot clé pour une recherche rapide ...">
                                    <p id="errcode" class="em no-margin text-danger"></p>
                                </div>
                            </div>
                          </div>
                              ...
                              <div class="card">
                                ...
                                <div class="card-body">
                                  <div class="row">
                                    <div class="col-md-4">
                                      <div class="form-group margin-bottom-20">
                                        <label class="d-block">Offre <span style="color:red">**</span></label>
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-group margin-bottom-20 d-none" id="offerType">
                                        <label class="d-block">Type Offre  <span style="color:red">**</span></label>
                                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                ...
                                <div class="card">
                                  ...
                                  <div class="card-body">
                                    <div class="row">
                                      <div class="col-md-2">
                                        <div class="form-group margin-bottom-20">
                                          <label class="d-block">Vente Flash <span style="color:red">**</span></label>
                                          <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                             data-width="100%" type="checkbox"
                                             name="flash_sale">
                                        </div>
                                      ...
                                      <div class="col-md-10 d-none" id="flashsale">
                                        <div class="row">
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group margin-bottom-20">
                                              <label class="d-block">Montant <span style="color:red">**</span></label>
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group margin-bottom-20">
                                              <label class="d-block">Date <span style="color:red">**</span></label>
                                              <div class="form-check form-check-inline">
                                          ...
                                          <div class="col-md-3">
                                            <div class="form-group margin-bottom-20">
                                              <label class="d-block">Temps interval <span style="color:red">**</span></label>
                                              <div class="form-check form-check-inline">
