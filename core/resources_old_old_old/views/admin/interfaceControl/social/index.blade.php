              ...
              <div class="col-md-12" style="margin-top:20px;">
                <div class="card">
                  <div class="card-header bg-primary">
                    <h5 style="color:white;margin:0px;"><i class="fa fa-list"></i> RESEAUX SOCIAUX</h5>
                  </div>
                  <div class="card-body">
                    @if (count($socials) == 0)
                      <h3 class="text-center">AUCUN LIEN RESEAU SOCIAL TROUVE</h3>
                    @else
                              ...
                              <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Supprimer la confirmation</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                    <h4 class="text-center">Êtes-vous sûr de vouloir supprimer ceci?</h4>
                                  </div>
