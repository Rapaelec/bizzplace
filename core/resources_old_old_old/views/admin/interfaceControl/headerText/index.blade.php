...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1>Réglage du texte d'en-tête</h1>
        </div>
     </div>
     <div class="row">
        <div class="col-md-12">
                ...
                <form action="{{route('admin.headerText.update')}}" method="post" role="form">
                   ...
                   <div class="form-body">
                      <div class="form-group">
                        <div class="row">
                          <label class="col-md-12 "><strong style="text-transform: uppercase;"> Texte minim</strong></label>
                          <div class="col-md-12">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <label class="col-md-12 "><strong style="text-transform: uppercase;">TEXTE EN GRAS</strong></label>
                          <div class="col-md-12">
