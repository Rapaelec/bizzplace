...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-dashboard"></i> Retirer la méthode de gestion</h1>
        </div>
            ...
            <div class="tile">
               <div>
                  <h3 class="page-title  uppercase bold">
                     ...
                     <i class="fa fa-plus"></i>  AJOUT NOUVEAU
                     </button>
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <div>
                              <div>
                                @if (count($wms) == 0)
                                <h3 class="text-center">Aucune méthode de retrait trouvée</h3>
                                @else
                                <table class="table table-bordered">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                       <td>{{$wm->name}}</td>
                                       <td><b>{{$wm->min_limit}} </b> A <b>{{$wm->max_limit}} {{$gs->base_curr_text}}</b></td>
