  ...
  <ul class="app-nav">
    ...
    <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu">{{Auth::guard('admin')->user()->username}} <i class="fas fa-caret-down"></i></a>
      <ul class="dropdown-menu settings-menu dropdown-menu-right">
        <li><a class="dropdown-item" href="{{route('admin.editProfile', Auth::guard('admin')->user()->id)}}"><i class="fa fa-cog fa-lg"></i> Editer Profile</a></li>
        <li><a class="dropdown-item" href="{{route('admin.changePass')}}"><i class="fa fa-cog fa-lg"></i>Changer le mot de passe</a></li>
        <li><a class="dropdown-item" href="{{route('admin.logout')}}"><i class="fas fa-sign-out-alt fa-lg"></i> Déconnexion</a></li>
      </ul>
    </li>
  </ul>
</header>
