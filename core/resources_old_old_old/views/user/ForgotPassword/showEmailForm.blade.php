      ...
      <div class="col-md-6 offset-md-3 email-form">
        <div class="card">
          <div class="card-header base-bg">
            <h3 class="text-white mb-0">Formulaire email</h3>
          </div>
          <div class="card-body">
            ...
            <form id="sendResetPassMailForm" action="{{route('user.sendResetPassMail')}}" class="" method="post">
              ...
              <div class="form-element square login">
                  <div class="form-element margin-bottom-20">
                      ...
                      <input style="border: 1px solid #ddd;" name="resetEmail" type="email" class="input-field" placeholder="Entrer votre adresse email ...">
                  </div>
