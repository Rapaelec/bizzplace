...
class LogoIconController extends Controller
{
    ...
    public function update(Request $request) {
      ...
      if($request->hasFile('footer_logo')) {
        $footerLogoImagePath = './assets/user/interfaceControl/logoIcon/footer_logo.jpg';
        @unlink($footerLogoImagePath);
        $request->file('footer_logo')->move('assets/user/interfaceControl/logoIcon/','footer_logo.jpg');
      }
