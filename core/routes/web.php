...
// Route::post('/category_view/store','User\CategoryAllController@store')->name('vendor.categoryAllstore');
Route::get('/category/{slug}/detail/{id}','User\CategoryAllController@detailAllCategorie')->name('user.categoryAlldetail');


Route::get('/test','DepartementController@JustUnTest')->name('test');
Route::get('/departement','DepartementController@getData')->name('get.departement');
Route::get('/cities','VilleController@getData')->name('get.cities');
Route::get('/search','searchController@tri')->name('search.tri');
Route::get('/testRegionQuery','RegionsController@JustUnTest')->name('get.region.query');
Route::get('/regions','RegionsController@getData')->name('get.regions');
...
Route::get('/otherproducts/{slug}/{id}', 'CategoryAllController@show')->name('user.categoryAlldetail.show');
Route::get('/otherproducts/{slug}/detail/{id}', 'CategoryAllController@detailOtherproduct')->name('user.OtherproductDetail.show');
...
Route::group(['middleware' => 'auth'], function() {
	  ...
	  // Profile routes
		...
		Route::get('/devis', 'User\ProfileController@demandeDevis')->name('entreprise.demande.devis');
		...
		Route::post('/SendDevisToAdmin','User\ProfileController@sendDevisToAdmin')->name('sendDevis');
		...
		Route::get('/employees/exemple','User\EmployeeController@ExempleExport')->name('user.exemple.export');
		...
		Route::get('/{orderid}/orderdetails/{vendorId?}', 'User\ProfileController@orderdetails')->name('user.orderdetails')->middleware('emailVerification', 'smsVerification', 'bannedUser');
...
Route::group(['prefix' => 'vendor', 'middleware' => ['auth:vendor']], function () {
	...
	Route::post('/category_view/store','Vendor\CategoryAllController@store')->name('vendor.categoryAllstore');
	Route::get('/category_view/{slug}/create','Vendor\CategoryAllController@create')->name('vendor.categoryAllcreate');
	Route::post('/category_view/{id}/update','Vendor\CategoryAllController@update')->name('vendor.categoryAllupdate');
	Route::get('/category_view/{id}/edit','Vendor\CategoryAllController@edit')->name('vendor.categoryAlledit');
	Route::post('/category_view/delete','Vendor\CategoryAllController@destroy')->name('vendor.categoryAlldestroy');
	...
	Route::post('/payment-confirm-formule', 'Vendor\GatewayController@paymentConfirmFormule')->name('payment.confirm.formule');
	Route::post('/payment', 'Vendor\GatewayController@paymentDataInsert')->name('payment');
	Route::get('/paymentPreviews', 'Vendor\GatewayController@paymentPreview')->name('vendor.paymentPreview');
	...
	// Order Routes
	Route::get('/commandes', 'Vendor\OrderController@orders')->name('vendor.orders')->middleware('bannedVendor');
 ...
 */
  ...
  Route::get('/category/{slug}/liste', 'Admin\CategoryController@liste_produit')->name('admin.category.list_produit');
  ...
  Route::post('/category/updateactivate', 'Admin\CategoryController@update_activate')->name('admin.category.update_activate');
