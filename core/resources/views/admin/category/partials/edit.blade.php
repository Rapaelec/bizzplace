                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="description_short" name="description_short" placeholder="Entrez une description courte" >{{ old('description_short') ? old('description_short') : $cat->description_short }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <strong>Description longue</strong>
                      <textarea class="form-control" id="description_long" name="description_long" placeholder="Entrez une description longue" >{{ old('description_long') ? old('description_long') : $cat->description_long }}</textarea>
                    </div>
                  </div>
                  <div class="col-md-12 mb-10">
                  ...
                  <div class="col-md-8">
                    <p class="text-danger font-weight-bold">Cette catégorie est elle soumise à validation ?</p>
                  </div>
                  <div class="col-md-1">
                    <div class="form-group">
                    <input class="form-check-input" type="radio" name="validation" id="validation_yes" value="1" {{ $cat->product_validate==1 ? 'checked' : '' }}>
                  ...
                  <div class="col-md-2 ml-1">
                    <div class="form-group">
                    <input class="form-check-input" type="radio" name="validation" id="validation_no" value="0" {{ $cat->product_validate==0 ? 'checked' : '' }}>
