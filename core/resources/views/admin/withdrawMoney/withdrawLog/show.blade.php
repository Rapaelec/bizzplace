...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h3 class="page-title uppercase bold">Retirer des détails</h3>
        </div>
                ...
                <div class="col-md-6">
                     ...
                     <div class="card">
                        <div class="card-header bg-primary">
                           <div style="color:white">
                              <h4><i class="fa fa-upload"></i> Retirer la demande</h4>
                           </div>
                        </div>
                        <div class="card-body">
                           ...
                           <i style="color: red;"> *** Charge déjà prise. Envoyer<strong>{{$withdraw->amount}}  {{$gs->base_curr_text}}</strong> À l'utilisateur</i>
                        </div>
                     </div>
                 ...
                 <div class="col-md-6">
                    <div class="card">
                       <div class="card-header bg-primary">
                          <div style="color:white;">
                             <h4><i class="fa fa-cogs"></i> Passer à l'action</h4>
                          </div>
                       </div>
                       <div class="card-body">
                          <form id="messageFormID" method="post">
                             <strong style="text-transform: uppercase;">Message ou Raison</strong><br><br>
                             {{csrf_field()}}
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                   <button onclick="storeMessage('processed', {{$withdraw->id}})" type="button" name="val" value="1" class="btn btn-primary btn-block btn-lg">TRAITÉ</button>
                                </div>
                                <div class="col-md-6">
                                   <button onclick="storeMessage('refunded', {{$withdraw->id}})" type="button" name="val" value="2" class="btn btn-danger btn-block btn-lg">REMBOURSER</button>
                                </div>
                             </div>
                          </form>
                       </div>
