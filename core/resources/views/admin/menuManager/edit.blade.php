  ...
  <main class="app-content">
     <div class="app-title">
       <div class="row" style="width:100%;">
         <div class="col-md-6">
           <h1 class="d-inline-block">Menu Modifier</h1>
         </div>
         <div class="col-md-6 text-right">
           <a href="{{route('admin.menuManager.index')}}" class="float-right btn btn-primary">Listes de menus</a>
         </div>
       </div>
     </div>
     <div class="row">
                   ...
                   <div class="form-body">
                       <div class="col-md-12">
                         <div class="form-group">
                           <label for="title">Nom Menu :</label>
