...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1>Réglage Frais de livraison</h1>
        </div>
     </div>
     <div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
              <div class="col-md-4">
                    <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                              <div class="col-md-12">
                              <label><strong>Paiement à la livraison</strong></label>
                              ...
                              <div class="col-md-12">
                              <label><strong>Frais de livraison anticipée</strong></label>
                              <div class="input-group mb-3">
                              ...
                              <span class="input-group-text" id="basic-addon2">{{$gs->base_curr_text}}</span>
                                  ...
                                  <div class="col-md-5">
                                  <label><strong>Livraison rapide</strong></label>
                                  <div class="input-group mb-3">
              ...
              <div class="col-md-4">
                    <div class="card">
                            <div class="card-header bg-primary"> 
                            <h3 class="text-white">    Autour de la ville</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                              <div class="col-md-12">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6">
                                <label>Taxe en pourcentage</label>
                                  <div class="input-group mb-3">
                                  <input name="tax" type="text" class="form-control form-control-lg" placeholder="Taxe en pourcentage" value="{{$gs->tax}}">
                                  <div class="input-group-append">
