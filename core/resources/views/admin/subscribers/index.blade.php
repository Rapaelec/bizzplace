...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-dashboard"></i> Envoyer NewsLetter</h1>
        </div>
              ...
              <div class="col-md-12">
                <form role="form" method="POST" action="{{route('admin.mailtosubsc')}}" enctype="multipart/form-data">
                   ...
                   <div class="form-body">
                      ...
                      <div class="form-group">
                         <label>Message électronique</label>
                   ...
                   <div class="form-actions">
                      <button type="submit" class="submit-btn btn btn-primary btn-lg btn-block login-button">Email de diffusion</button>
                   </div>
                </form>
              </div>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header bg-primary">
                    <h3 class="text-white"><i class="fa fa-list"></i>TOUS LES ABONNÉS</h3>
                  </div>
                  <div class="card-body">
