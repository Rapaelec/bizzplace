...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1>AJOUTER / SOUSTRACTER LA BALANCE</h1>
        </div>
     </div>
     <div class="row">
        <div class="col-md-12">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="input-group mb-3">
                            <input name="amount" type="text" value="{{old('amount')}}" class="form-control" placeholder="Enter Amount" aria-label="Nom d'utilisateur du destinataire" aria-describedby="basic-addon2">
