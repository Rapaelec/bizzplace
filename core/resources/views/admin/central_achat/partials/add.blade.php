          ...
          <div class="row">
              <div class="col-md-4">
                <div class="form-group margin-bottom-20">
                    ...
                    <select name="category" type="text" class="form-control" v-model="catid" {{-- @change="showsubcats()" --}} onchange="showsubcats()">
              ...
              <div class="col-md-4">
                <div class="form-group margin-bottom-20">
                    ...
                    <select name="subcategory" type="text" class="form-control" v-model="subcatid" id="selsub" {{-- @change="showattrs()" --}} onchange="showattrs()">
