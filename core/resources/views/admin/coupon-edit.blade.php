...
@push('scripts')
  <script>
    ...
    function changePlaceholder(val) {
      ...
      if (val == 'fixed') {
        document.getElementsByName('coupon_amount')[0].placeholder = 'Entrer la remise dans ' + currtxt;
        $("#minamount").addClass("d-block");
        $("#minamount").removeClass("d-none");
      } else if (val == 'percentage') {
        document.getElementsByName('coupon_amount')[0].placeholder = 'Entrez le rabais en pourcentage';
        $("#minamount").addClass("d-none");
