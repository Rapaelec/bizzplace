           ...
           <div class="tile-body">
            ...
            @foreach($categories as $categorie)
                 <div class="col-md-4 {{ $loop->index > 2 ? 'mt-3' : '' }}">
                  <div class="card">
                    <div class="card-header bg-primary"> <h3 class="text-white">Gestion des {{ $categorie->name }}</h3></div>
                     <div class="card-body">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-12">
                        <a href="{{ route('vendor.categorie',(Illuminate\Support\Str::slug($categorie->name))) }}" class="btn btn-success  btn-block">
                        J'utilise ce service
                        </a>
                        @if($categorie->validation!=0)
                        <p style='color:red'>N.B: Cette catégorie est soumise à validation, la publication dans cette catégorie nécéssite une validation de la part de l'administrateur.</p>
                        @endif
                     </div>
                     </div>
                     </div>
