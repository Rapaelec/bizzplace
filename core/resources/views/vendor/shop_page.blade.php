                  ...
                  <div class="category-sidebar"><!-- category sidebar -->
                      <div class="category-filter-widget"><!-- category-filter-widget -->
                        <div class="sidebar-header">
                          ...
                          <ul class="cat-list">
                            <li>
                              <a href="{{url('/').'/shop_page'.'/'.$vendorid}}" class="{{!Request::route('category') ? 'base-txt' : '' }}">Toutes les categories </a>
                            </li>
              ...
              <div class="col-lg-9">
                  <div class="right-content-area"><!-- right content area -->
                      ...
                      <div class="bottom-content"><!-- top content -->
                          <div class="row">
                            @if (count($products) == 0 and count($immobiliers)==0 and count($services)==0)
                              <div class="col-md-12 text-center">
                                <h4>PAS D'ELEMENT TROUVE</h4>
                              </div>
                            @else
                              @foreach ($products as $key => $product)
                                <div class="col-lg-4 col-md-6">
                                  <div class="single-new-collection-item "><!-- single new collections -->
                                      ...
                                      <div class="content">
                                          <span class="category text-dark">{{\App\Category::find($product->category_id)->name}}</span>
                              ...
                              @foreach ($immobiliers as $key => $immobilier)
                                <div class="col-lg-4 col-md-6">
                                  <div class="single-new-collection-item "><!-- single new collections -->
                                      ...
                                      <div class="content">
                                          <span class="category text-dark">{{\App\Category::find($immobilier->category_id)->name}}</span>
