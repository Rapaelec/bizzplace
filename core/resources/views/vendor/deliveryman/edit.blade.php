                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-element margin-bottom-20">
                                  ...
                                  <select name="category" type="text" class="input-field" v-model="catid" {{-- @change="showsubcats()" --}} onchange="showsubcats()">
                                    @foreach ($cats as $cat)
                            ...
                            <div class="col-md-4">
                              <div class="form-element margin-bottom-20">
                                  ...
                                  <select name="subcategory" type="text" class="input-field" v-model="subcatid" id="selsub" {{-- @change="showattrs()" --}} onchange="showattrs()">
