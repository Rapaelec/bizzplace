  ...
  <div class="col-sm-8 offset-md-2">
    ...
    <form id="reviewform" class="" onsubmit="reviewsubmit(event)">
      ...
      <div class="form-group">
        <textarea name="comment" class="form-control" rows="5" cols="120" placeholder="Commentaire (Optional)"></textarea>
      </div>
      <div class="form-group text-center">
        <button type="submit" class="btn base-bg white-txt">Envoyer</button>
      </div>
    </form>
  </div>
</div>
