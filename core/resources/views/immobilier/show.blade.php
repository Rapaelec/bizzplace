                  ...
                  <div class="recently-added-carousel" id="recently-added-carousel"><!-- recently added carousel -->
                    @foreach ($r_immobiliers as $key => $r_immobilier)
                      <div class="single-new-collection-item "><!-- single new collections -->
                        <span class="badge badge-info mb-1" style="margin-left: 65%; font-size: 91%;"><i class="fa fa-eye"></i> Vues {{$r_immobilier->number_views}}</span>  
                        <div class="thumb">
                              <img src="{{asset('assets/user/img/products/'.$r_immobilier->previewimages()->first()->image)}}" alt="new collcetion image">
                              <div class="hover">
                                <a href="{{route('user.immobilierdetail.show', [$r_immobilier->slug, $r_immobilier->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                              </div>
                          </div>
                          
                          <div class="content">
                              <span class="category text-dark font-weight-bold">{{ \App\Category::find($r_immobilier->category_id)->name}}</span>
                              <a href="{{route('user.immobilierdetail.show', [$r_immobilier->slug, $r_immobilier->id])}}"><h4 class="title">{{strlen($r_immobilier->nom) > 25 ? substr($r_immobilier->nom, 0, 25) . '...' : $r_immobilier->nom}}</h4></a>
