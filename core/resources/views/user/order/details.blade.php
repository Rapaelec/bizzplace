...
@section('content')
  ...
  <div class="sellers-product-content-area">
        ...
        <div class="row mb-4">
          ...
          @else
            <div class="col-md-6">
              <div class="card">
                <div class="card-header base-bg">
                  <h6 class="white-txt no-margin">Détails client</h6>
                </div>
                <div class="card-body">
                  <p><strong>Nom et Prénom: </strong>{{$order->first_name}} {{$order->last_name}}</p>
                ...
                <div class="card order-summary">
                  ...
                  <div class="card-body">
                    <ul>
                      ...
                      <li><span class="left">TAXE</span> <span class="right">{{-- {{ $gs->base_curr_symbol }} --}} {{ $order->tax }} {{-- {{$order->subtotal*($gs->tax/100)}} --}}%</span></li>
    ...
    {{-- @if($order->shipping_status == 2 && $order->approve == 1)
