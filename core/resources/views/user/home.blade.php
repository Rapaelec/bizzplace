                                      ...
                                      @foreach ($flashsales as $key => $flashsale)
                                        <div class="single-new-collection-item"><!-- single new collections -->
                                            <div class="thumb">
                                              ...
                                              <div class="hover">
                                                <a href="{{route('user.productdetail.show', [$flashsale->slug,$flashsale->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                                              </div>
                                            ...
                                            <div class="content">
                                                ...
                                                <a href="{{route('user.productdetail.show', [$flashsale->slug,$flashsale->id])}}"><h4 class="title">{{strlen($flashsale->title) > 20 ? substr($flashsale->title, 0, 20) . '...' : $flashsale->title}}</h4></a>
                                         ...
                                         <div class="tab-content" >
                                             <div class="tab-pane fade show active" id="bestseller" role="tabpanel" aria-labelledby="bestseller-tab">
                                                 <div class="row">
                                                   ...
                                                   @if($topSoldPro->previewimages()->count()>0 && $topSoldPro->previewimages()->first()->product_validate == 1)
                                             ...
                                             <div class="tab-pane fade" id="trendeseller" role="tabpanel" aria-labelledby="trendeseller-tab">
                                               <div class="row">
                                                  ...
                                                  @if($topRatedPro->previewimages()->count()>0 && $topRatedPro->previewimages()->first()->product_validate == 1)
                                                  <div class="col-lg-3 col-md-6">
                                                    <div class="single-new-collection-item "><!-- single new collections -->
                                                        <div class="thumb">
                                                            <img src="{{asset('assets/user/img/products/'.$topRatedPro->previewimages()->first()->image)}}" alt="new collcetion image">
                                                            <div class="hover">
                                                              <a href="{{route('user.productdetail.show', [$topRatedPro->slug, $topRatedPro->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                                                            </div>
                                                        </div>
                                                        <div class="content">
                                                            <span class="category">{{\App\Category::find($topRatedPro->category_id)->name}}</span>
                                                            <a href="{{route('user.productdetail.show', [$topRatedPro->slug, $topRatedPro->id])}}"><h4 class="title">{{strlen($topRatedPro->title) > 20 ? substr($topRatedPro->title, 0, 20) . '...' : $topRatedPro->title}}</h4></a>
                                             ...
                                             <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                               <div class="row">
                                                 ...
                                                 @if($specialPro->previewimages()->count()>0 && $specialPro->previewimages()->first()->product_validate == 1)
                                                   <div class="col-lg-3 col-md-6">
                                                     <div class="single-new-collection-item "><!-- single new collections -->
                                                         <div class="thumb">
                                                             ...
                                                             <div class="hover">
                                                               <a href="{{route('user.productdetail.show', [$specialPro->slug, $specialPro->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                                                             </div>
                                                         </div>
                                                         <div class="content">
                                                             <span class="category">{{\App\Category::find($specialPro->category_id)->name}}</span>
                                                             <a href="{{route('user.productdetail.show', [$specialPro->slug, $specialPro->id])}}"><h4 class="title">{{strlen($specialPro->title) > 20 ? substr($specialPro->title, 0, 20) . '...' : $specialPro->title}}</h4></a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="recently-added-carousel cat-carousel" id="recently-added-carousel"><!-- recently added carousel -->
                          ...
                          @if($product->previewimages()->count()>0 && $product->previewimages()->first()->product_validate == 1)
                          <div class="single-new-collection-item "><!-- single new collections -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="recently-added-carousel cat-carousel" id="recently-added-carousel"><!-- recently added carousel -->
                          ...
                          @if($evenement->previewimages()->count()>0 && $evenement->previewimages()->first()->product_validate == 1)
                            <div class="single-new-collection-item "><!-- single new collections -->
                              <span class="badge badge-info mb-1" style="margin-left: 65%; font-size: 91%;"><i class="fa fa-eye"></i> Vues {{$evenement->number_views}}</span>
                                <div class="thumb">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="recently-added-carousel cat-carousel" id="recently-added-carousel"><!-- recently added carousel -->
                          ...
                          @if($service->previewimages()->count()>0 && $service->previewimages()->first()->product_validate == 1)
                            <div class="single-new-collection-item "><!-- single new collections -->
                              <span class="badge badge-info mb-1" style="margin-left: 65%; font-size: 91%;"><i class="fa fa-eye"></i> Vues {{$service->number_views}}</span>
                                <div class="thumb">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="recently-added-carousel cat-carousel" id="recently-added-carousel"><!-- recently added carousel -->
                          ...
                          @if($immobilier->previewimages()->count()>0 && $immobilier->previewimages()->first()->product_validate == 1)
                            <div class="single-new-collection-item "><!-- single new collections -->
                              <span class="badge badge-info mb-1" style="margin-left: 65%; font-size: 91%;"><i class="fa fa-eye"></i> Vues {{$immobilier->number_views}}</span>
                                <div class="thumb">
                                ...
                                <div class="content">
                                    ...
                                    <a href="{{route('user.immobilierdetail.show', [$immobilier->slug, $immobilier->id])}}"><h4 class="title font-weight-bold" style="color:black;">{{strlen($immobilier->nom) > 20 ? substr($immobilier->nom, 0, 20) . '...' : $immobilier->nom}}</h4></a>
              ...
              <div class="col-lg-12">
                  <div class="recently-added-carousel" id="recently-added-carousel"><!-- recently added carousel -->
                    @foreach ($latestPros as $key => $latestPro)
                      @if($latestPro->previewimages()->count() && $latestPro->previewimages()->first()->product_validate == 1)
                      <div class="single-new-collection-item "><!-- single new collections -->
                        {{-- <span class="badge badge-info mb-1" style="margin-left: 65%; font-size: 91%;"><i class="fa fa-eye"></i> Vues {{$latestPro->previewimages()->first()->number_views}}</span> --}}
                          <div class="thumb">
                              <img src="{{asset('assets/user/img/products/'.$latestPro->previewimages()->first()->image)}}" alt="nouvelle collection image">
                              <div class="hover">
                                <a href="{{route('user.productdetail.show', [$latestPro->slug,$latestPro->id])}}" class="view-btn"><i class="fa fa-eye"></i></a>
                              </div>
                          </div>
                          <div class="content">
                              <span class="category">{{\App\Category::find($latestPro->category_id)->name}}</span>
                              <a href="{{route('user.productdetail.show', [$latestPro->slug,$latestPro->id])}}"><h4 class="title">{{strlen($latestPro->title) > 20 ? substr($latestPro->title, 0, 20) . '...' : $latestPro->title}}</h4></a>
