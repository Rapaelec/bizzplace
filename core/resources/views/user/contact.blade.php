          ...
          <div class="row">
            <div class="col-md-12">
              <div class="inner-section-title">
                  <strong class="subtitle base-txt">Nous Contacter</strong>
                  <h2 class="title">Pour obtenir plus d'information</h2>
              </div>
            </div>
                      ...
                      <ul>
                          ...
                          <li>
                              <div class="single-contact-info-item"><!-- single contact info item -->
                                  ...
                                  <div class="content">
                                      <span class="title">Quartier Général</span>
                        ...
                        <form action="{{route('user.contactMail')}}" class="contact_form" method="post">
                          {{csrf_field()}}
                            ...
                            <div class="btn-wrapper">
                                <button type="submit" class="submit-btn btn-success">Envoyer</button>
                            </div>
                        </form>
                    </div>
                </section>
