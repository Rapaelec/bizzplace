                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <ul class="list-group text-center">
                                ...
                                <li class="list-group-item">Sous total: <strong>{{getSubTotal(Auth::user()->id)}} </strong>{{$gs->base_curr_text}}</li>
                                @php
                                ...
                                @endphp
                                <li class="list-group-item">Taxe: <strong>{{($gs->tax*getSubTotal(Auth::user()->id))/100}} </strong>{{$gs->base_curr_text}}</li>
                                <li class="list-group-item">Frais de port: <strong>{{$scharge}} </strong>{{$gs->base_curr_text}}</li>
                                <li class="list-group-item">Total: <strong>{{$data->amount}} </strong>{{$gs->base_curr_text}}</li>
                                <li class="list-group-item">En EUR: <strong>{{$data->usd_amo}}</strong></li>
                            </ul>
                        </div>
