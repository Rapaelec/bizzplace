...
<div class="row" style="height:25%">
    ...
    {{-- <div class="col-md-4" style="padding-top:1%;">
      <label for="pays_sect" ><strong>Pays</strong></label>
      <select name='pays_sect' class="pays_sect" style="width:100%">
      </select>
    </div> --}}
    <div class="col-md-4" style="padding-top:1%;">
                  ...
                  <div class="right-content-area"><!-- right content area -->
                      ...
                      <div class="bottom-content"><!-- top content -->
                          <div class="row">
                            ...
                            @if($evenement->category->product_validate==1)
                              ...
                              <div class="col-md-12">
                                <div class="text-center">
                                    {{$evenements->appends($parameters)->links()}}
                                </div>
                              </div>
                            @endif
                          </div>
