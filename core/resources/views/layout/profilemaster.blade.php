            ...
            <div class="card" style="width: 100%;">
              <div class="user-sidebar">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item"><a class="sidebar-links @if(route::is('user.professional')) active @endif" href="{{route('user.professional')}}">Professionels</a></li>
                  <li class="list-group-item"><a class="sidebar-links @if(route::is('user.wishlist')) active @endif" href="{{route('user.wishlist')}}">Mes favoris</a></li>
                  ...
                  <li class="list-group-item"><a class="sidebar-links @if(request()->path()=='devis') active @endif" href="{{ route('entreprise.demande.devis') }}">Demande de devis</a></li>
                  <li class="list-group-item"><a class="sidebar-links @if(request()->path()=='changepassword') active @endif" href="#">Achat carte KDO ou Privilège</a></li>
