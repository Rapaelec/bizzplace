                ...
                <form class="form-horizontal" action="{{route('admin.flashsale.updatetimes')}}" method="post" role="form">
                   ...
                   <div class="form-body">
                     <div class="form-group">
                        <label class="col-md-12 "><strong style="text-transform: uppercase;">Intervalles de temps dans une journée</strong></label>
                        ...
                        <div class="col-md-12 mt-2">
                          <button type="button" class="btn btn-primary" @click="incrinterval"><i class="fa fa-plus"></i> Ajouter un intervalle de temps</button>
                        </div>
                     </div>
                      <div class="form-group">
                         <div class="col-md-12">
                            <button type="submit" class="btn btn-info btn-block btn-lg">METTRE À JOUR</button>
                         </div>
                      </div>
                   </div>
                </form>
