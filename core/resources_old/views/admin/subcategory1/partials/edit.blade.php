...
<div class="modal fade" id="editModal{{$subcat->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form class="" action="{{route('admin.subcategory1.update')}}" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-10">
                    ...
                    <select class="form-control" name="status">
                      <option value="1" {{($subcat->status==1) ? 'selected' : ''}}>Activer</option>
                      <option value="0" {{($subcat->status==0) ? 'selected' : ''}}>Desactiver</option>
                    </select>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <strong>Les attributs (Optional)</strong>
                      <div class="">
                        @php
