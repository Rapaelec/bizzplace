...
@section('title', 'Mise à jour du produit')

@section('headertxt', 'Mise à jour du produit')
                      ...
                      <form id="uploadForm" class="product-upload-form" onsubmit="upload(event)" enctype="multipart/form-data">
                          ...
                          <div class="form-element margin-bottom-20">
                            ...
                            <div class="form-group">
                              ...
                              <p class="no-margin"><small>5 images au maximum  peuvent être téléchargées</small></p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                              <div class="form-element margin-bottom-20">
                                  <label>Sous catégorie <span>**</span></label>
                            ...
                            <div class="col-md-4">
                              <div class="form-element margin-bottom-20">
                                  <label>Code produit <span>(Optionel)</span></label>
                                  <input name="product_code" type="text" class="input-field" value="{{$product->product_code}}" placeholder="Entrez le code produit...">
                                  <small>Si vous ne spécifiez pas un code de produit unique, il sera généré automatiquement.</small>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-element margin-bottom-20 d-none" id="offerType">
                                        <label class="d-block">Type d'offre  <span>**</span></label>
                                        <input data-toggle="toggle" data-onstyle="success" data-offstyle="danger"
                                    ...
                                    <div class="col-md-4">
                                      <div class="form-element margin-bottom-20 d-none" id="offerAmount">
                                        <label>Montant de l'offre <span>**</span></label>
                                        <input name="offer_amount" type="text" class="input-field" placeholder="Entrer le montant de l'offre..." value="{{$product->offer_amount}}">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-10" id="flashsale">
                                      <div class="row">
                                        ...
                                        <div class="col-md-3">
                                          <div class="form-element margin-bottom-20">
                                            <label class="d-block">Compte <span>**</span></label>
                                            <div class="form-check form-check-inline">
                          ...
                          <div class="btn-wrapper mt-4 d-block">
                              <input type="submit" class="submit-btn" value="Mise à jour du produit">
                          </div>
                      </form>
      ...
      if (flashamount.length > 0) {
        ...
        if (price.length > 0) {
          ...
          if (flashtype == 'on') {
            ...
            let total = price - offer;
            $("#calcTotalFlash").html('<strong>Prix: </strong>'+price + ' ' + curr +'<br/><strong>Offer: </strong>'+offer + ' ' + curr +'<br/><strong>Total: </strong>' + total + ' ' + curr);
          } else {
            // if offer type is Fixed...
            let total = price - flashamount;
            $("#calcTotalFlash").html('<strong>Prix: </strong>'+price + ' ' + curr + '<br/><strong>Offer: </strong>'+flashamount + ' ' + curr+'<br/><strong>Total: </strong>' + total + ' ' + curr);
          }
    ...
    function upload(e) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if (data=="success") {
            swal("Success!", "Le produit a été mis à jour avec succès!", "success");
          }
          // if error occurs
