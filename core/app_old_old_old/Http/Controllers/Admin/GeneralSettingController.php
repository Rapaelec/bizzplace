    ...
    public function UpdateGenSetting(Request $request){
      // return $request->all();
        $messages = [
          ...
          'baseColorCode.required' => 'Le code de couleur de base est requis',
          'baseColorCode.size' => 'Le code de couleur de base doit comporter 6 caractères.',
          'decimalAfterPt.required' => 'Décimal après le point est requis',
        ];
